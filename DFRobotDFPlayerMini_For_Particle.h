 ...
 * @file DFRobotDFPlayerMini_For_Particle.h
...
#ifndef DFRobotDFPlayerMini_For_Particle_cpp
#define DFRobotDFPlayerMini_For_Particle_cpp
...
class DFRobotDFPlayerMini_For_Particle
{
private:
    Stream *_serial;
